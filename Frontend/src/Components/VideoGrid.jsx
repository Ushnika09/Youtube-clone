    ...
    <>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 pb-4.5">
        {channel.videos.map((video) => (
          <div
            key={video._id}
            className="bg-white dark:bg-gray-800 rounded-lg shadow-md flex flex-col transition-transform hover:scale-[1.02] hover:shadow-lg relative"
          >
            {/* Thumbnail */}
            ...
            <div
              className={`p-3 flex-1 flex flex-col ${
                mode ? "bg-black/40 text-white" : "bg-neutral-200 text-black"
              }`}
            >
              ...
              <div className="flex items-center justify-between mt-2">
                ...
                <div className="relative menu-container">
                  ...
                  {activeMenu === video._id && (
                    <div
                      className={`absolute right-0 mt-2 rounded-md shadow-lg py-1 z-[100] border min-w-[120px] ${
                        mode ? "border-gray-700 bg-gray-800" : "border-gray-300 bg-white"
                      }`}
                    >
                      <button
